...
let BigEditNgforComponent = class BigEditNgforComponent {
    constructor(data, resolver, cdr) {
        this.data = data;
    ...
    ngAfterViewChecked() {
        ...
        if (this.ready && this.containers) {
            ...
            this.containers.forEach((c, i) => {
                let f = c['_view'].context.$implicit;
                let type = i > 0 ? _ui_comp_ui_comp_component__WEBPACK_IMPORTED_MODULE_3__["UiCompComponent"] : _ui_comp_inherited_ui_comp_inherited_component__WEBPACK_IMPORTED_MODULE_4__["UiCompInheritedComponent"];
                ...
                let baseRef = componentRef.instance;
...
BigEditNgforComponent.ctorParameters = () => [
...
let BigEditComponent = class BigEditComponent {
    constructor(data, resolver, cdr) {
        this.data = data;
        this.resolver = resolver;
        this.cdr = cdr;
...
BigEditComponent.ctorParameters = () => [
    { type: src_app_services_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ComponentFactoryResolver"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] }
];
...
let BigLogComponent = class BigLogComponent {
...
BigLogComponent.ctorParameters = () => [
    { type: src_app_services_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ComponentFactoryResolver"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let UiCompInheritedComponent = class UiCompInheritedComponent extends _ui_comp_ui_comp_component__WEBPACK_IMPORTED_MODULE_2__["UiCompComponent"] {
    constructor(_data) {
        super(_data);
        this._data = _data;
    }
...
UiCompInheritedComponent.ctorParameters = () => [
...
let UiCompComponent = class UiCompComponent {
    constructor(data) {
        this.data = data;
        this.pinkMe = false;
        this.mylist = [];
...
UiCompComponent.ctorParameters = () => [
    { type: src_app_services_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] }
];
